...
class LanguageFilterModal extends StatefulWidget {
  const LanguageFilterModal(this.regionFilterCallback, {Key? key})
      : super(key: key);
  final Function regionFilterCallback;

  @override
  State<LanguageFilterModal> createState() => _LanguageFilterModalState();
}

class _LanguageFilterModalState extends State<LanguageFilterModal> {
                                          ...
                                          return Row(
                                            ...
                                            children: [
                                              AppText(
                                                  size: 18,
                                                  text:
                                                      '${model.elementAt(index).languages}'),
                                              Transform.scale(
                                                scale: 1.3,
                                                child: Checkbox(
