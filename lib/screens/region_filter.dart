...
import 'package:explore_app_1/widgets/buttons/custom_checkbox.dart';
...
class _RegionFilterModalState extends State<RegionFilterModal> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      color: !darkActive ? Color(0xff161616) : Color(0xff727375),
      child: Container(
          decoration: BoxDecoration(
            color: darkActive ? Colors.white : Color(0xff000F24),
